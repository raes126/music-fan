module.exports = {
	...
	token: "NzczMjg3NDk3MzE2NDMzOTYz.X6HCGg.GonGSgC3VVNv0OAa2L3RGoNV9Pk",
	/* For the support server */
	support: {
		id: "759525742747844628", // The ID of the support server
		logs: "809828624718233611", // And the ID of the logs channel of your server (new servers for example)
	},
	...
	dashboard: {
		...
		logs: "809828624718233611", // The channel ID of logs
